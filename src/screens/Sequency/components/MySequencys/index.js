...
export default class MySequencys extends Component {
  constructor(props) {
    super(props);
    this.state = {
    };
    ...
    return (
      <View style={styles.container}> 
        ...
        <TouchableOpacity style={styles.item}>
          ...
          <View style={styles.itemTitle}>
            <Text style={styles.itemText}>Minha rotina de skin care noturna. </Text>              
          </View>
        ...
        <TouchableOpacity style={styles.item}>
          ...
          <View style={styles.itemTitle}>
            <Text style={styles.itemText}>Maquiagem carnaval tendência 2021. </Text>              
          </View>
